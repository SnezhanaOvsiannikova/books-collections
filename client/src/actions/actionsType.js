...
export const ADD_NEW_BOOK_TO_COLLECTION_REQUEST =
  "ADD_NEW_BOOK_TO_COLLECTION_REQUEST";
export const ADD_NEW_BOOK_TO_COLLECTION_SUCCESS =
  "ADD_NEW_BOOK_TO_COLLECTION_SUCCESS";
export const ADD_NEW_BOOK_TO_COLLECTION_FAILED =
...
export const DELETE_BOOK_FROM_COLLECTION_REQUEST =
  "DELETE_BOOK_FROM_COLLECTION_REQUEST";
export const DELETE_BOOK_FROM_COLLECTION_SUCCESS =
  "DELETE_BOOK_FROM_COLLECTION_SUCCESS";
export const DELETE_BOOK_FROM_COLLECTION_FAILED =
